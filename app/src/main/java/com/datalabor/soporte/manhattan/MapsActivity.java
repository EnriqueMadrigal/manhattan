...
import com.datalabor.soporte.manhattan.models.Sucursal;
...
import com.datalabor.soporte.manhattan.Common;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    ArrayList<Sucursal> _sucursales;
    Context context;
    ...
    private void LoadDistribuidores()
    {
        ...
        String jsonDistribuidores = Common.loadJSONFromAsset(context,"sucursales.json");
        ...
        try {
            ...
            JSONArray res = obj_distribuidores.getJSONArray("sucursales");

            for (int i = 0; i < res.length(); i++) {
                distribuidor = res.getJSONObject(i).getJSONObject("sucursal");
